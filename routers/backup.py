...
@backup_router.post('/backup', tags=['backup-restore'], response_model=dict, status_code=201, dependencies=[Depends(JWTBearer())])
...
@backup_router.post('/restore', tags=['backup-restore'], response_model=dict, status_code=201, dependencies=[Depends(JWTBearer())])
